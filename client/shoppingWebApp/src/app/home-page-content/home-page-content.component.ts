...
@Component({
  ...
  styleUrl: './home-page-content.component.css'
})
export class HomePageContentComponent implements OnInit {
  ...
  productCategoryList = [
    { name: 'Vợt', image: 'sanpham/vot1/main.png' },
    { name: 'Áo', image: 'phukien/ao/ao1.jpg' },
    { name: 'Balo', image: 'phukien/balo/balo1.jpg' },
    { name: 'Giày', image: 'phukien/giay/giay1.jpg' },
